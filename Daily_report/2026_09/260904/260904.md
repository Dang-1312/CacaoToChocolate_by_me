...
## Option 2
- Dùng Jetson Nano đọc cảm biến PT100 thông qua ([Raspberry Pi Pico 2 W RP2350](https://raspberrypi.vn/san-pham/mach-raspberry-pi-pico-2w))
- Có hai phương án nhỏ:
    + Jetson Nano làm Gateway nhận dữ liệu từ các Node Raspberry Pi Pico 2 W RP2350 thông qua mạng
    ![Option 2.1](./Option_2_1.png)
    + Jetson Nano nhận dữ liệu nối tiếp thông qua dây cáp USB từ Raspberry Pi Pico 2 W RP2350
    ![Option 2.2](./Option_2_2.png)

## Bổ sung yêu cầu và chốt Option lần 1
- Yêu cầu: Giai đoạn lên men có bước kiểm tra hạt cacao đã lên men đủ độ bằng Camera AI 
> Dùng Jetson Nano để chạy Camera AI detect
- Chốt Option lần 1:
![Option final 1](./Option_final_1.png)
